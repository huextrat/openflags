      ...
      <div className="max-w-lg mx-auto mt-12 text-center">
        ...
        <div className="p-8 rounded-2xl border border-red-500/20 bg-red-500/5 shadow-[0_0_30px_rgba(239,68,68,0.1)]">
          ...
          <p className="text-white/70">
            You don't have permission to create projects. Contact an administrator.
          </p>
        </div>
      </div>
    )
            ...
            <div className="flex items-center gap-4 mb-2">
              ...
              <div>
                ...
                <CardDescription className="text-white/50 text-base mt-1">
                  Get started by naming your new feature flag environment.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
              ...
              <div className="space-y-5 rounded-2xl border border-white/5 bg-black/20 p-5 shadow-inner">
                ...
                <TextFieldRoot name="slug" className="relative">
                  <TextFieldLabel className="text-white/70">
                    Project Slug{" "}
                    <span className="text-white/40 text-xs font-normal ml-2">(Used in API)</span>
                  </TextFieldLabel>
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3 pt-4 border-t border-white/5 mt-8">
                <Link to="/" className="w-full sm:w-auto">
                  <Button
                    type="button"
                    variant="ghost"
                    className="w-full h-11 hover:bg-white/5 text-white/70 hover:text-white"
                  >
                    Cancel
                  </Button>
                </Link>
                <Button
                  type="submit"
                  className="w-full sm:w-auto h-11 px-8 shadow-[0_0_20px_rgba(139,92,246,0.25)] hover:shadow-[0_0_30px_rgba(139,92,246,0.4)] transition-all"
                >
                  Create Project
                </Button>
              </div>
